declare global {
  ...
  function TM_request(details: httpRequestOptions): Promise<httpResponse>
  ...
  namespace Swal {
     ...
     * ```
     */
    function fire<T = any>(options: SweetAlertOptions<T>): Promise<SweetAlertResult<AwaitedRe<T>>>
     ...
     * ```
     */
    function fire<T = any>(title?: string, html?: string, icon?: SweetAlertIcon): Promise<SweetAlertResult<AwaitedRe<T>>>
  ...
  type AwaitedRe<T> = T extends Promise<infer U> ? U : T
